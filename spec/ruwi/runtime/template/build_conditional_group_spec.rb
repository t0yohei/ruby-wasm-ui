...
RSpec.describe Ruwi::Template::BuildConditionalGroup do
  ...
  describe '.get_conditional_expression' do
    ...
    context 'when element has r-if attribute with embedded script' do
      before do
        ...
        allow(Ruwi::Template::BuildVdom).to receive(:embed_script?).with('{state[:visible]}').and_return(true)
        allow(Ruwi::Template::BuildVdom).to receive(:get_embed_script).with('{state[:visible]}').and_return('state[:visible]')
      end
    ...
    context 'when element has r-elsif attribute with plain value' do
      before do
        ...
        allow(Ruwi::Template::BuildVdom).to receive(:embed_script?).with('condition').and_return(false)
      end
  ...
  describe '.build_single_conditional_content' do
    ...
    context 'when element is a template' do
      before do
        ...
        allow(Ruwi::Template::BuildVdom).to receive(:has_data_template_attribute?).with(mock_element).and_return(false)
        allow(Ruwi::Template::BuildVdom).to receive(:build_fragment).with(mock_element, 'template').and_return('fragment_result')
      end
    ...
    context 'when element is a div with data-template attribute' do
      before do
        ...
        allow(Ruwi::Template::BuildVdom).to receive(:has_data_template_attribute?).with(mock_element).and_return(true)
        allow(Ruwi::Template::BuildVdom).to receive(:build_fragment).with(mock_element, 'div').and_return('fragment_result')
      end
    ...
    context 'when element is a component' do
      before do
        ...
        allow(Ruwi::Template::BuildVdom).to receive(:has_data_template_attribute?).with(mock_element).and_return(false)
        allow(Ruwi::Template::BuildVdom).to receive(:is_component?).with('custom-component').and_return(true)
        allow(Ruwi::Template::BuildVdom).to receive(:build_component).with(mock_element, 'custom-component', filtered_attributes).and_return('component_result')
      end
    ...
    context 'when element is a regular HTML element' do
      before do
        allow(mock_element).to receive(:[]).with(:tagName).and_return('DIV')
        allow(Ruwi::Template::BuildVdom).to receive(:has_data_template_attribute?).with(mock_element).and_return(false)
        allow(Ruwi::Template::BuildVdom).to receive(:is_component?).with('div').and_return(false)
        allow(Ruwi::Template::BuildVdom).to receive(:build_element).with(mock_element, 'div', filtered_attributes).and_return('element_result')
      end
