...
RSpec.describe Ruwi::Template::BuildVdom do
  ...
  describe '.build' do
    ...
    context 'when processing element nodes' do
      ...
      before do
        ...
        allow(Ruwi::Template::BuildConditionalGroup).to receive(:has_conditional_attribute?).with(mock_element_node).and_return(false)
        # Mock has_for_attribute? to return false
        allow(Ruwi::Template::BuildForGroup).to receive(:has_for_attribute?).with(mock_element_node).and_return(false)
      end

      it 'builds VDOM for element nodes' do
        result = described_class.build(mock_elements)
        expect(result).to eq("Ruwi::Vdom.h('div', {}, [])")
      end
    end
    ...
    context 'when processing template (fragment) nodes' do
      ...
      before do
        ...
        # Mock has_conditional_attribute? to return false
        allow(Ruwi::Template::BuildConditionalGroup).to receive(:has_conditional_attribute?).with(mock_template_node).and_return(false)
      end

      it 'builds VDOM for fragment nodes' do
        result = described_class.build(mock_elements)
        expect(result).to eq("Ruwi::Vdom.h_fragment([])")
      end
    end
    ...
    context 'when processing div elements with data-template attribute' do
      ...
      before do
        ...
        # Mock has_conditional_attribute? to return false
        allow(Ruwi::Template::BuildConditionalGroup).to receive(:has_conditional_attribute?).with(mock_div_template_node).and_return(false)
      end
    ...
    context 'when processing components' do
      ...
      before do
        ...
        # Mock has_conditional_attribute? to return false
        allow(Ruwi::Template::BuildConditionalGroup).to receive(:has_conditional_attribute?).with(mock_component_element).and_return(false)
        # Mock has_for_attribute? to return false
        allow(Ruwi::Template::BuildForGroup).to receive(:has_for_attribute?).with(mock_component_element).and_return(false)
      end

      it 'builds VDOM for components with PascalCase names' do
        result = described_class.build(mock_elements)
        expect(result).to eq("Ruwi::Vdom.h(CustomComponent, {}, [])")
      end
    end
    ...
    context 'when processing components with conditional attributes' do
      ...
      before do
        ...
        allow(Ruwi::Template::BuildConditionalGroup).to receive(:has_conditional_attribute?).with(mock_component_element).and_return(true)
        # Mock has_for_attribute? to return false
        allow(Ruwi::Template::BuildForGroup).to receive(:has_for_attribute?).with(mock_component_element).and_return(false)
        ...
        allow(Ruwi::Template::BuildConditionalGroup).to receive(:build_conditional_group)
      ...
      it 'processes conditional attributes on components' do
        ...
        expect(Ruwi::Template::BuildConditionalGroup).to have_received(:build_conditional_group)
      end
    end
    ...
    context 'when processing components with r-for attributes' do
      ...
      before do
        ...
        allow(Ruwi::Template::BuildForGroup).to receive(:has_for_attribute?).with(mock_component_element).and_return(true)
        ...
        allow(Ruwi::Template::BuildForGroup).to receive(:build_for_loop)
      ...
      it 'processes r-for attributes on components with splat operator' do
        ...
        expect(Ruwi::Template::BuildForGroup).to have_received(:build_for_loop)
      end
    end
    ...
    context 'when processing elements with r-for attributes' do
      ...
      before do
        ...
        # Mock has_conditional_attribute? to return false
        allow(Ruwi::Template::BuildConditionalGroup).to receive(:has_conditional_attribute?).with(mock_li_element).and_return(false)
        # Mock has_for_attribute? to return true
        allow(Ruwi::Template::BuildForGroup).to receive(:has_for_attribute?).with(mock_li_element).and_return(true)
  ...
  describe '.build_element' do
    ...
    it 'builds HTML element with lowercase tag name' do
      ...
      expect(result).to eq("Ruwi::Vdom.h('span', {}, [])")
    end
  end
end
