  ...
  module Utils
    module Arrays
      ...
      class ArrayWithOriginalIndices
        attr_reader :array, :original_indices
        ...
        def is_removal?(index, new_array)
          ...
          item = @array[index]
          index_in_new_array = new_array.find_index { |new_item| new_item == item }
      ...
      def self.diff_sequence(old_array, new_array)
        sequence = []
        array = ArrayWithOriginalIndices.new(old_array)
